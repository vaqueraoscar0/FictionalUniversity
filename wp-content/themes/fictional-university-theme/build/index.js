...
class Like {
  ...
  events() {
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.like-box').on('click', this.ourClickDispatcher.bind(this));
  } //methods


  ourClickDispatcher(e) {
    var currentLikeBox = jquery__WEBPACK_IMPORTED_MODULE_1___default()(e.target).closest('.like-box');
  ...
  deleteLike(currentLikeBox) {
    jquery__WEBPACK_IMPORTED_MODULE_1___default().ajax({
      ...
      url: universityData.root_url + '/wp-json/university/v1/deleteLike',
      type: 'DELETE',
      data: {
